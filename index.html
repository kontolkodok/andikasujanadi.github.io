...
<html lang="en">
	...
	<body onload="init()">
		...
		<div class="container">
			...
			<div class="pengembang">Kodok Salto</div>
		</div>
		...
		<script type="text/javascript">
			...
			function specialEffects(){
				if(localStorage.getItem("manualColor")=="#4c1130"){
					setTimeout(function() { createNote("Tetap Semangat"); }, 5000);
				}
				else if(localStorage.getItem("manualColor")=="#000000"){
					setTimeout(function() { createNote("Open jasa nemenin kamu dari nol:v minat dm"); }, 5000);
				}
			}
			...
			const quotes = [
			  {
			    "quote": "Hai Sobat Ambyarrrr",
			    "source": "Kodok"
			  },
			  {
			    "quote": "Semua yang sempat pergi tidak akan datang dalam keadaan yang sama",
			    "source": "Kodok"
			  },
			  {
			  ...
			  {
			    "quote": "Kita hanya sebuah kebetulan yang entah mengapa dapat bertahan selama ini",
			    "source": "Kodok"
			  },
			  {
			    "quote": "Seperti detak dan detik pada jam dinding. Jika suatu saat aku berhenti, itu hanya karena ku mati",
			    "source": "Kodok"
			  },
			  {
			    "quote": "Aku pernah melewati puluhan malam dengan berharap kau akan datang kembali. Dan melewati puluhan malam pula harus kecewa karena kau tak juga kembali",
			    "source": "Kodok"
			  },
			  {
			    "quote": "Aku benci aku yang masih rindu kamu",
			    "source": "Kodok"
			  },
			  {
			    "quote": "Maaf aku tidak se-istimewa Yogyakarta, tak sehangat Bali. Namun berharap bisa lebih nyaman dari kedua tempat itu",
			    "source": "Kodok"
			  },
			  {
			    "quote": "Mari belajar melepaskan mereka mereka yang pergi karena berfikir bukan kau yang terbaik",
			    "source": "Kodok"
			  },
			  {
			    "quote": "Bagian yang paling sulit dari perpisahan kemarin adalah ketika aku dipaksa melepaskan tanpa sedikitpun hak untuk bertahan",
			    "source": "Kodok"
			  },
			  {
			    "quote": "Cinta bukan hanya tentang saling menerima apa adanya. Cinta adalah Harga Diri",
			    "source": "Tere Liye"
			  },
			]
